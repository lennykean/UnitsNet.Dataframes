...
{
    //public static IMetadataDictionary<TMetadata> GetDataframeMetadata<TObject, TMetadata>(this TObject obj, CultureInfo? culture = null)
    //    where TObject : class
    //    where TMetadata : QuantityMetadata, IMetadata<TMetadata>
    //{
    //    var metadataProvider = obj as IMetadataProvider<TMetadata>
    //        ?? GlobalMetadataProvider<TMetadata>.Instance;
    ...
    //    where TObject : class
    //{
    //    return obj.GetDataframeMetadata<TObject, QuantityMetadata>(culture);
    //}

    //public static IQuantity GetQuantity<TObject, TMetadata>(this TObject obj, Expression<Func<TObject, QuantityValue>> propertySelectorExpression, CultureInfo? culture = null)
    //    where TObject : class
    //    where TMetadata : QuantityMetadata, IMetadata<TMetadata>
    //{
    //    if (obj is null)
    ...
    //    return obj.GetQuantityFromProperty<TObject, TMetadata>(property, culture);
    //}

    //public static IQuantity GetQuantity<TObject, TMetadata>(this TObject obj, string propertyName, CultureInfo? culture = null)
    //    where TObject : class
    //    where TMetadata : QuantityMetadata, IMetadata<TMetadata>
    //{
    //    if (obj is null)
    ...
    //    where TObject : class
    //{
    //    return obj.GetQuantity<TObject, QuantityMetadata>(propertySelectorExpression);
    //}

    //public static IQuantity GetQuantity<TObject>(this TObject obj, string propertyName)
    //    where TObject : class
    //{
    //    return obj.GetQuantity<TObject, QuantityMetadata>(propertyName);
    //}

    //public static IQuantity ConvertQuantity<TObject, TMetadata>(this TObject obj, Expression<Func<TObject, QuantityValue>> propertySelectorExpression, Enum to)
    //    where TObject : class
    //    where TMetadata : QuantityMetadata, IMetadata<TMetadata>
    //{
    //    var propertyName = propertySelectorExpression.ExtractPropertyName();
    ...
    //    return obj.ConvertQuantity<TObject, TMetadata>(property, to);
    //}

    //public static IQuantity ConvertQuantity<TObject, TMetadata>(this TObject obj, string propertyName, Enum to)
    //    where TObject : class
    //    where TMetadata : QuantityMetadata, IMetadata<TMetadata>
    //{
    //    var property = typeof(TObject).GetProperty(propertyName) ??
    ...
    //    where TObject : class
    //{
    //    return obj.ConvertQuantity<TObject, QuantityMetadata>(propertySelectorExpression, to);
    //}

    //public static IQuantity ConvertQuantity<TObject>(this TObject obj, string propertyName, Enum to)
    //    where TObject : class
    //{
    //    return obj.ConvertQuantity<TObject, QuantityMetadata>(propertyName, to);
    //}

    //private static IQuantity ConvertQuantity<TObject, TMetadata>(this TObject obj, PropertyInfo property, Enum to)
    //    where TObject : class
    //    where TMetadata : QuantityMetadata, IMetadata<TMetadata>
    //{
    //    if (obj is null)
